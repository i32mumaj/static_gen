...
def generate_page(from_path: str, template_path: str, to_path: str, base_path: str | None) -> None:
...
def generate_pages_recursively(from_dir: str, template_path: str, to_dir: str, base_path: str | None) -> None:
    ...
    for file in os.listdir(from_dir):
        ...
        if os.path.isdir(from_path):
            ...
            generate_pages_recursively(from_path, template_path, new_to_dir, base_path)
        if file.endswith('.md'):
